...
def changeclass(arr):
    outarr  = np.zeros(shape=(arr.shape[0]))
    for i in range(arr.shape[0]):
        if arr[i] == 1 or arr[i] == 7:
            outarr[i] = 0
        elif arr[i] == 0 or arr[i] == 6 or arr[i] == 8 or arr[i] == 9:
            outarr[i] = 1
        elif arr[i] == 2 or arr[i] == 5:
            outarr[i] = 2
        elif arr[i] == 3 or arr[i] == 4:
            outarr[i] = 3
    return outarr
...
y_train = changeclass(y_train)
y_test = changeclass(y_test)
